...
c=g.O(c)}return g.modify(a,{headers:g.modify(a.headers,{"Content-Type":b,"Content-Length":c.length}),body:c})},send:d};g.f={stringify:d,parse:d};g.path={join:d};g.K=function(a){var b=require("fs"),c=require("path");try{return JSON.parse(b.Y(c.join(__dirname,"../common",a+".json")))}catch(e){return d}};
...
return b};g.f.stringify=function(a){var b=[],c;for(c in a)b.push(encodeURIComponent(c)+(a[c]==d?"":"="+encodeURIComponent(a[c])));return b.join("&")};g.B(q,i);g.c.send=function(a,b){var c=new XMLHttpRequest;c.onreadystatechange=function(){if(2==c.readyState){var a=new q(c);b(2!=(c.g/100|0)&&c.g,a)}};c.open(a.method,g.url.d(a.url),!0);for(var e in a.headers)c.setRequestHeader(e,a.headers[e]);c.send(a.body)};g.path.join=function(){var a=Array.prototype.slice.call(arguments),b=document.createElement("a");
b.href=window.location.href;b.pathname=a.join("/").replace(/\/+/g,"/");return b.pathname.substr(a[0]&&"/"==a[0][0]?0:1)}};var r="undefined"==typeof exports?this.Z={}:exports,g="undefined"==typeof require?g:require("./remutil");r.t="Mozilla/5.0 (compatible; REMbot/1.0; +http://rem.tcr.io/)";r.C=d;
