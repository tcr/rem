...
var Route = (function () {
  ...
  Route.prototype.del = function (query, next) {
    if (arguments.length == 1) next = query, query = null;
  ...
  Route.prototype.post = function (query, mime, body, next) {
    if (arguments.length == 3)
      if (typeof query == 'string') next = body, body = mime, mime = this.defaultBodyMime;
      else next = body, body = mime, mime = query, query = null;
    if (arguments.length == 2) next = body, body = mime, mime = this.defaultBodyMime, query = null;
    if (arguments.length == 1) next = mime, body = null, mime = this.defaultBodyMime, query = null;
  ...
  Route.prototype.patch = function (query, mime, body, next) {
    if (arguments.length == 3)
      if (typeof query == 'string') next = body, body = mime, mime = this.defaultBodyMime;
      else next = body, body = mime, mime = query, query = null;
    if (arguments.length == 2) next = body, body = mime, mime = this.defaultBodyMime, query = null;
  ...
  Route.prototype.put = function (query, mime, body, next) {
    if (arguments.length == 3)
      if (typeof query == 'string') next = body, body = mime, mime = this.defaultBodyMime;
      else next = body, body = mime, mime = query, query = null;
    if (arguments.length == 2) next = body, body = mime, mime = this.defaultBodyMime, query = null;
